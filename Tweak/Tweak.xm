...
%ctor {
  NSLog(@"[Axon] init");
  CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)loadPrefs, CFSTR("com.q1643240.axon17/ReloadPrefs"), NULL, CFNotificationSuspensionBehaviorCoalesce);
  loadPrefs();
